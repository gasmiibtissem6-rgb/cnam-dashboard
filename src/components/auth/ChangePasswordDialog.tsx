    ...
    <Dialog open={open} onOpenChange={forceChange ? undefined : onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            {forceChange
              ? "Votre mot de passe a expiré (plus de 30 jours). Nous vous recommandons de le changer maintenant."
              : "Sécurisez votre compte avec un nouveau mot de passe."}
          </DialogDescription>
        </DialogHeader>

        {step === "choose" && forceChange && onRemindLater && (
          <div className="flex justify-end -mt-2">
            <Button variant="ghost" size="sm" onClick={onRemindLater} className="text-muted-foreground">
